package com.example.datastructure.dataStructure.heap;
...
class MinHeapTest {
    public class MinHeap<E> {
        ...
        private final int DEFAULT_CAPACITY = 10;	// 최소(기본) 용적 크기
        ...
        public void add(E value) {
            ...
            System.out.println(value + " add complete!");
        }
        ...
        public int size() {
            System.out.println("Heap size is " + this.size + "!");
            return this.size;
        }
        ...
        public E peek() {
            ...
            System.out.println((E)array[1] + " Peek!");
            return (E)array[1];
        }
        ...
        public Object[] toArray() {
            System.out.println(Arrays.toString(Arrays.copyOf(array, size + 1)));
